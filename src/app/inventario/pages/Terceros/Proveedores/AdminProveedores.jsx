...
export const AdminProveedores = () => {
  ...
  const rows = [
    createData("01", "Proveedor 1", "Contacto 1"),
    createData("02", "Proveedor 2", "Contacto 2"),
    createData("03", "Proveedor 3", "Contacto 3"),
  ...
  const actions = (provider) => (
    <>
      <EditButton item={provider} onClick={handleOpenEditDialog} />
      <DeleteButton item={provider} onClick={handleOpenConfirmDialog} />
    </>
    );
